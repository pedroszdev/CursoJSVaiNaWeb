...
Responsividade: A página deve se adaptar perfeitamente a diferentes tamanhos de tela (móvel, tablet e desktop), utilizando unidades relativas e media queries.
...
Banner Principal: Uma seção de boas-vindas com o título "Cuidar da saúde é um ato de amor".

A Importância dos Exames: Cards que destacam os pilares da prevenção: Detecção Precoce, Cuidado Familiar e Qualidade de Vida.

Prevenção Feminina: Uma seção com fundo rosa que detalha, através de cards, os exames recomendados para mulheres por faixa etária (a partir dos 15, 20, 25, 30, 40 e 50 anos).

Prevenção Masculina: Uma seção similar, com fundo cinza, focada nos exames de rotina para homens, também divididos por idade.

Alertas Importantes: Cards coloridos que chamam a atenção para o autoexame das mamas, autoexame dos testículos, vacinação e saúde mental.
